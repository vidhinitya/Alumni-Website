<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Defaultlogin.aspx.cs" Inherits="_Default" %>
                    ...
                    <table width="550">
                        <tr>
                            ...
                            <td style="vertical-align:top" >
                                <h2 style="margin:5px 0 0 20px; padding:0; text-align:justify; font-size:23px;color:#325571;font-family: 'Belgrano', serif; font-weight:normal; width: 394px;" >Madhuben and Bhanubhai Patel Institute of Technology Alumni Association</h2>
                            </td>
                        </tr>
                    </table>
                </div>
                            ...
                            <table class="form" style="margin-left:10px;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtName" runat="server" class="medium" AutoCompleteType="FirstName" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;">  
                                        <asp:TextBox ID="txtAddress" runat="server" class="large" AutoCompleteType="HomeStreetAddress" Width="550px" Enabled="false" ></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;">  
                                    ...
                                    <td style="padding-top:5px;">  
                                        <asp:TextBox ID="txtCity" runat="server" class="mini" AutoCompleteType="HomeCity" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtMobile" runat="server" class="mini" AutoCompleteType="Cellular" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                               ...
                               <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtAEmail" runat="server" class="medium" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtClgID" runat="server" class="mini" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:DropDownList ID="ddlYOA" runat="server" CssClass="mini" Enabled="false">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:DropDownList ID="ddlYOG" runat="server" CssClass="mini" Enabled="false" >
                                            <asp:ListItem>Select One</asp:ListItem>
                                            <asp:ListItem>2004</asp:ListItem>
                                            <asp:ListItem>2005</asp:ListItem>
                                            <asp:ListItem>2006</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtPercentage" runat="server" class="mini" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="margin:0; padding-top:5px" colspan="2" >
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:DropDownList ID="ddlEntrance" runat="server" CssClass="mini" Enabled="false" >
                                            <asp:ListItem>Select One</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtOExam" runat="server" class="medium" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;" colspan="3"> 
                                        <table style="margin:0; padding:0">
                                            <tr>
                                                ...
                                                <td>    
                                                    <asp:TextBox ID="txtObtained" runat="server" Width="80px" Enabled="false"></asp:TextBox> 
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtOutof" runat="server" Width="80px" Enabled="false"></asp:TextBox> 
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:DropDownList ID="ddlYOAEdu" runat="server" CssClass="mini" Enabled="false">
                                            <asp:ListItem>Select One</asp:ListItem>
                                            <asp:ListItem>2000</asp:ListItem>
                                            <asp:ListItem>2001</asp:ListItem>
                                            <asp:ListItem>2002</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtNOI" runat="server" class="large" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtNOC" runat="server" class="large" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:DropDownList ID="ddlYOGEdu" runat="server" CssClass="mini" Enabled="false">
                                            <asp:ListItem>Select One</asp:ListItem>
                                            <asp:ListItem>2004</asp:ListItem>
                                            <asp:ListItem>2005</asp:ListItem>
                                            <asp:ListItem>2006</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtPercentageEdu" runat="server" class="mini" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:RadioButtonList ID="ddlStatus" runat="server" Height="20px" RepeatDirection="Horizontal" CssClass="radio" Enabled="false">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:RadioButtonList ID="ddlPlacement" runat="server" Height="20px" RepeatDirection="Horizontal" CssClass="radio" Width="110" onselectedindexchanged="ddlPlacement_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtYPlacement" runat="server" class="large" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                </div>
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtCompanyname" runat="server" class="medium" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtCompanytype" runat="server" class="medium" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtDOJ" runat="server" class="mini" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtDesignation" runat="server" class="mini" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px;"> 
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtAnnual" runat="server" class="mini" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:RadioButtonList ID="ddlExperience" runat="server" Height="20px" RepeatDirection="Horizontal" CssClass="radio" Width="250" Enabled="false">
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:RadioButtonList ID="ddlTeaching" runat="server" Height="20px" RepeatDirection="Horizontal" CssClass="radio" Width="250" Enabled="false">
                                            <asp:ListItem> Excellent </asp:ListItem>
                                            <asp:ListItem> Good </asp:ListItem>
                                            <asp:ListItem> Fair </asp:ListItem>
                                        </asp:RadioButtonList>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:RadioButtonList ID="ddlLibrary" runat="server" Height="20px" RepeatDirection="Horizontal" CssClass="radio" Width="250" Enabled="false">
                                            <asp:ListItem> Excellent </asp:ListItem>
                                            <asp:ListItem> Good </asp:ListItem>
                                            <asp:ListItem> Fair </asp:ListItem>
                                        </asp:RadioButtonList>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:RadioButtonList ID="ddlLaboratory" runat="server" Height="20px" RepeatDirection="Horizontal" CssClass="radio" Width="250" Enabled="false">
                                            <asp:ListItem> Excellent </asp:ListItem>
                                            <asp:ListItem> Good </asp:ListItem>
                                            <asp:ListItem> Fair </asp:ListItem>
                                        </asp:RadioButtonList>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:RadioButtonList ID="ddlSports" runat="server" Height="20px" RepeatDirection="Horizontal" CssClass="radio" Width="250" Enabled="false">
                                            <asp:ListItem> Excellent </asp:ListItem>
                                            <asp:ListItem> Good </asp:ListItem>
                                            <asp:ListItem> Fair </asp:ListItem>
                                        </asp:RadioButtonList>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:RadioButtonList ID="ddlHostel" runat="server" Height="20px" RepeatDirection="Horizontal" CssClass="radio" Width="250" Enabled="false">
                                            <asp:ListItem> Excellent </asp:ListItem>
                                            <asp:ListItem> Good </asp:ListItem>
                                            <asp:ListItem> Fair </asp:ListItem>
                                        </asp:RadioButtonList>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px;"> 
                                        <asp:TextBox ID="txtFeed" runat="server" class="large" TextMode="MultiLine" BorderColor="#eaeaea" BorderStyle="solid" BorderWidth="1px" Width="360px" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:5px; vertical-align:top"> 
